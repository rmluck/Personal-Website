        ...
        <div className={`${color}`}>
            ...
            >
                {items.map(({ skill, logo }) => (
                    <div key={skill} className="flex flex-col bg-accent/70 rounded-md shadow-md border-2 border-pro600 justify-center items-center gap-4 p-4 hover:scale-105 transition-transform duration-300 cursor-hover cursor-none">
