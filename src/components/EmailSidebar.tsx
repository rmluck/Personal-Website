    ...
    return (
        <div className="hidden md:flex fixed -right-7 bottom-0 flex-col items-center space-y-6">
            ...
            <a
                ...
                className="text-pro600 dark:text-pro400 hover:text-accent transform origin-bottom-left hover:translate-x-1 transition-all duration-200 cursor-hover cursor-none"
            >
