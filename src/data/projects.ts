export const projects = [
    ...
    },
    {
        ...
        brief: "Natural language processing pipeline for classifying IMDB movie reviews based on review sentiment.",
        description: "Natural language processing (NLP) pipeline developed to classify IMDB movie reviews as positive or negative based on review sentiment analysis. Built for the \"Bag of Words Meets Bags of Popcorn\" Kaggle competition. Implemented text preprocesing techniques including tokenization, stopword removal, and lemmatization to clean and prepare review text data with Google's Word2Vec embeddings. Developed and trained several machine learning models including Random Forest and XGBoost classifiers to achieve 86% cross-validated accuracy",
        start_date: "August 2025",
        end_date: "August 2025",
        image: "",
        skills: {
    ...
    },
    {
        ...
        description: "Air quality analysis program that receives location and Air Quality Index threshold as inputs and connects to PurpleAir API for air quality monitoring sensor data to determine variable number of nearby locations with poorest air quality. Nominatim API, forward geocoding, and reverse geocoding methods used to calculate nearest locations.",
        start_date: "February 2022",
        end_date: "February 2022",
        image: "",
        skills: {
